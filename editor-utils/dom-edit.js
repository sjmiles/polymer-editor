module('dom-edit', 
  ['dom-utils', 'dom-position', 'dom-selection', 'preorder-iter'],
  function(DomUtils, DomPosition, Selection, PreOrderIter) {

  'use strict';

  var DomEdit = {

    handleEditIntent: function(intent, context) {
      var m = this[intent];
      if (typeof m === 'function') {
        return m.call(this, context);
      }
    },
